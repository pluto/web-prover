...
// const SQUARE_ZEROTH_GRAPH: &[u8] =
// include_bytes!("../../examples/circuit_data/square_zeroth.bin"); const SWAP_MEMORY_GRAPH: &[u8] =
// include_bytes!("../../examples/circuit_data/swap_memory.bin");
