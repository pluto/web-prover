...
pub use super::notify::{BackendNotifier, BackendNotify};
...
pub trait Backend: Send {
    ...
    /// Gets handshake hash at ClientKeyExchange for EMS.
    ...
    /// tk: hacky method for setting witness h7 field in `client::tls13`
