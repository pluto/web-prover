//! Brings in circuit from [web-prover-circuits](https://github.com/pluto/web-prover-circuits)to be embedded into the client during compile time.
...
pub fn construct_setup_data_1024() -> SetupData {
  SetupData {
    ...
    witness_generator_types: vec![WitnessGeneratorType::Browser; 4],
