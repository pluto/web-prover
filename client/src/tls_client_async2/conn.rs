...
/// # Note
///
/// This connection is closed on a best-effort basis if this is dropped. To ensure a clean close,
/// you should call [`AsyncWriteExt::close`](futures::io::AsyncWriteExt::close) to close the
/// connection.
#[derive(Debug)]
